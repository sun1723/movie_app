...
export const MovieCard = ({movie,index,fetchMovieById}) => {
  ...
  return (
    <Grid container spacing={2} 
      id = {index}
      key = {movie.imdbID}
      style={{ width: '100%', backgroundColor: (hoverIndex == index) ? '#1B9CB3': '#195A66', height: '150px', marginBottom: '15px'}}
