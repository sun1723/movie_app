    ...
    <div className="star-rating">
      <div className="star-rating_stars">
        <StarRateIcon
          id="1"
          ref={(node) => {
            if (starNum >= 1) starRef.current[0] = node;
          }}
        />
        <StarRateIcon
          id="2"
          ref={(node) => {
            if (starNum >= 2) starRef.current[1] = node;
          }}
        />
        <StarRateIcon
          id="3"
          ref={(node) => {
            if (starNum >= 3) starRef.current[2] = node;
          }}
        />
        <StarRateIcon
          id="4"
          ref={(node) => {
            if (starNum >= 4) starRef.current[3] = node;
          }}
        />
        <StarRateIcon
          id="5"
          ref={(node) => {
            if (starNum >= 5) starRef.current[4] = node;
          }}
        />
      </div>
    </div>
